...
plot_dist(models[1])
plt.tight_layout()
plt.savefig(os.path.join(eval_path, '2022-01-25-Figure1.png'))
plt.clf()
...
# savefile = os.path.join(model_path,f'2022-01-25-mix.sav')
...
m_mix  = pickle.load(open(os.path.join(model_path,f'2022-01-25-mix.sav'),'rb'))
...
plt.savefig(os.path.join(eval_path, '2022-01-25-Figure3.png'))
plt.clf()
...
plt.ylabel('Concentration (nM)')
plt.title('Simulated DA response and prediction from models')
plt.savefig(os.path.join(eval_path, '2022-01-25-Figure4.png'))
plt.clf()
...
plt.yscale('log')
plt.savefig(os.path.join(eval_path, '2022-01-25-Figure5.png'))
plt.clf()
